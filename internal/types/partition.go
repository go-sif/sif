...
type CloneablePartition interface {
	...
	GetPublicSchema() sif.Schema                          // GetPublicSchema retrieves the public Schema from the most recent task that manipulated this Partition. Represents the client-facing schema.
	GetPrivateSchema() sif.Schema                         // GetPrivateSchema retrieves the private Schema from the most recent task that manipulated this Partition. Represents the true, underlying structure of the data in this Partition.
