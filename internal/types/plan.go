...
type Plan interface {
	...
	Execute(ctx context.Context, conf *PlanExecutorConfig, statsTracker *stats.RunStatistics, isCoordinator bool) PlanExecutor // Creates a PlanExecutor given a particular configuration
}
