...
type CloneablePartition interface {
	...
	GetCurrentSchema() sif.Schema                         // GetCurrentSchema retrieves the Schema from the most recent task that manipulated this Partition
	GetWidestSchema() sif.Schema                          // GetWidestSchema retrieves the widest Schema from the stage that produced this Partition, which is equal to the size of a row
